...
export const getDirection = (direction: string, oSlug: string, teas: TeaProduct[]): string => {
...
export function useKeyboardNavigation(teas: TeaProduct[]) {
  ...
  useHotkeys('left', () => setSelectedSlug(getDirection('left', selectedSlug, teas)), [selectedSlug, teas]);
  useHotkeys('right', () => setSelectedSlug(getDirection('right', selectedSlug, teas)), [selectedSlug, teas]);
  useHotkeys('up', () => setSelectedSlug(getDirection('up', selectedSlug, teas)), [selectedSlug, teas]);
  useHotkeys('down', () => setSelectedSlug(getDirection('down', selectedSlug, teas)), [selectedSlug, teas]);
}
